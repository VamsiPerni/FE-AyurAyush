        ...
        >
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 w-full sm:w-auto">
                <div className="flex items-center gap-3">
                    <div
                        className={`shrink-0 w-10 h-10 rounded-full flex items-center justify-center ${isEmergency ? "bg-red-100 text-red-600" : "bg-primary-50 text-primary-600"}`}
                    >
                        <User className="w-5 h-5" />
                    </div>
                    <div className="flex-1">
                        <h4 className="font-semibold text-neutral-800 tracking-tight">
                            {name}
                        </h4>
                        <div className="flex items-center gap-1.5 mt-0.5 text-xs text-neutral-500 font-medium">
                            ...
                            <span>{timeSlot}</span>
                            {tokenNumber && (
                                <span className="inline-flex items-center gap-1 ml-2 px-2 py-0.5 rounded-md bg-primary-50 text-primary-700 font-mono border border-primary-100">
