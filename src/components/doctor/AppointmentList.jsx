          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 text-sm text-gray-500 mt-0.5">
                  <span className="flex items-center gap-1">
                    <Clock size={12} />
                    {apt.timeSlot || apt.appointmentDetails?.timeSlot}
                  </span>
                  {(apt.symptoms?.length > 0 ||
                    apt.appointmentDetails?.symptoms?.length > 0) && (
                    <span className="truncate">
                      {(apt.symptoms || apt.appointmentDetails?.symptoms || [])
                        .slice(0, 2)
                        .join(", ")}
                    </span>
                  )}
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                <Badge
                  variant={
                    apt.urgencyLevel === "emergency" ? "emergency" : apt.status
                  }
                >
                  {apt.urgencyLevel === "emergency" ? "Emergency" : undefined}
                </Badge>
