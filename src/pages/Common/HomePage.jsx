    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-[#065A82] via-[#1C7293] to-[#02C39A] text-white">
        <div className="max-w-6xl mx-auto px-4 py-20 md:py-28 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">AyurAyush</h1>
          <p className="text-lg md:text-xl text-white/85 max-w-2xl mx-auto mb-8">
            AI-powered Hospital Management System. Smart health assessments,
            seamless appointment booking, and comprehensive care management.
          </p>
      ...
      <footer className="border-t border-gray-100 py-6 text-center text-sm text-gray-500">
        &copy; {new Date().getFullYear()} AyurAyush — AI-Powered Healthcare
      </footer>
    </div>
  );
};
